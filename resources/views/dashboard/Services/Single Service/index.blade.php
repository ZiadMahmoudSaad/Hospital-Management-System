...
@section('title')
    {{trans('Dashboard/main-sidebar.Single_service')}}
@stop
@section('css')
    <!--Internal   Notify -->
...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">{{trans('Dashboard/main-sidebar.Services')}}</h4><span
                    class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{trans('Dashboard/main-sidebar.Single_service')}}</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
